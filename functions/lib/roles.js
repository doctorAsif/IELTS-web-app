...
exports.bootstrapSuperAdmin = exports.setRole = void 0;
...
exports.setRole = (0, https_1.onCall)(async (request) => {
    ...
    if (callerRole !== 'superadmin' && callerRole !== 'admin') {
        throw new https_1.HttpsError('permission-denied', 'You do not have permission to assign roles.');
    }
    ...
    try {
        ...
        throw new https_1.HttpsError('internal', 'Error setting role.');
    }
});
...
exports.bootstrapSuperAdmin = (0, https_1.onCall)(async (request) => {
    ...
    if (secret !== expectedSecret) {
        throw new https_1.HttpsError('permission-denied', 'Invalid bootstrap secret.');
    }
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'Must be authenticated to bootstrap yourself.');
    }
    ...
    try {
        ...
        throw new https_1.HttpsError('internal', 'Error bootstrapping superadmin.');
    }
});
