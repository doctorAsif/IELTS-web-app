...
import { Headphones, CheckCircle, XCircle, Loader2, Sparkles } from 'lucide-react';
...
export const ListeningModule: React.FC<ListeningModuleProps> = ({ practiceId = 'AKHL-LS-001' }) => {
  ...
  return (
    <div className="p-6 bg-[#1E293B] border border-[#334155] rounded-3xl max-w-4xl mx-auto my-6 text-white shadow-xl">
      ...
      {/* Audio Script / Simulation */}
      <div className="bg-[#0F172A] p-5 rounded-2xl border border-[#334155] mb-6 space-y-2 text-sm text-slate-200 leading-relaxed max-h-80 overflow-y-auto">
        <p className="text-xs font-bold uppercase tracking-wider text-sky-400 mb-2">Listening Audio Transcript</p>
